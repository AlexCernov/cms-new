...
//                    var topic = db.Topics.Include("Role").FirstOrDefault(x => x.Description == description);
//                    Topics.Add(topic);
//                }
//            }
//        }
...
//                    var callforpaper = new CallForPapers(CallForPapers.Acronym, Topics);
//                    Status = CheckEntity(service, callforpaper);
//                }
//                catch (InternetException ex)
//                {
...
//        public CreateCallForPapersViewModel(ModelState, CallForPapers callForPapers, CallForPaperService callForPaperService) : this(isValid)
//        {
//            if (isValid)
//            {
//                try
